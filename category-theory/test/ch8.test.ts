...
import {Just, makeJust, makeNone, Maybe, None} from '../src/maybe'
...
const powerOf: (power: number) => (base: number) => number = pow => base => base ** pow
    ...
    describe('bifunctor', () => {
        ...
        describe('Pair as bifunctor', () => {
            it('can make a custom bifunction', () => {
                ...
                const [a,b] = spyOnTheValuesOfBifunctor(pair.bimap(plus3)(doubling))
    ...
    describe('Show the isomorphism between the standard definition of Maybe and this desugaring:', () => {
        describe('type Maybe\' a = Either (Const () a) (Identity a)', () => {
            ...
            it('isomorphism in Const() / none', () => {
                ...
                const resultOfNone: None = noneValue.fmap(powerOf(3))
                // we need to take the value, as resultOfLeft would be a const.
                const resultOfLeft = leftValue.bimap(makeConst)(noop).value
            ...
            it('isomorphism in right/just', () => {
                ...
                const resultOfJust: Just<number> = justValue.fmap<number>(powerOf(2))
